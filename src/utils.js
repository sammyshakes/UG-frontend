...
import ugRaid4Abi from "./abis/ugRaid4_abi.json";
import ugRaidEntry4Abi from "./abis/raidEntry4_abi.json";
import ugArena3Abi from "./abis/ugArena3_abi.json";
import ugGame5Abi from "./abis/ugGame5_abi.json";
import ugYakDenAbi from "./abis/ugYakDen_abi.json";
import fclubAlleyAbi from "./abis/fclubAlley_abi.json";
...
const getUGArena3 = () => {
  return new ethers.Contract(ugArena3Address, ugArena3Abi, getEthers());
};
...
const getUGGame5 = () => {
  return new ethers.Contract(ugGame5Address, ugGame5Abi, getEthers());
};
...
const getRaidEntry4 = () => {
  return new ethers.Contract(raidEntry4Address, ugRaidEntry4Abi, getEthers());
};
...
const getUGRaid4 = () => {
  return new ethers.Contract(ugRaid4Address, ugRaid4Abi, getEthers());
};

const getUGYakDen = () => {
  return new ethers.Contract(ugYakDenAddress, ugYakDenAbi, getEthers());
};

const getFclubAlley = () => {
  return new ethers.Contract(fclubAlleyAddress, fclubAlleyAbi, getEthers());
};

const getUGForgeSmith2 = () => {
  return new ethers.Contract(
    ugForgeSmith2Address,
    ugForgeSmith2Abi,
    getEthers()
  );
};
