...
const StakedFightClubCard = (props) => {
  ...
  const updateProgress = async () => {
    const levelUpCost = await ugGameContract.getFightClubLevelUpBloodCost(
      props.level,
      props.size,
      1,
      0
    );
    const sizeUpCost = await ugGameContract.getFightClubLevelUpBloodCost(
      props.level,
      props.size,
      0,
      1
        ...
        <CardContent align="center" sx={{ p: 1, color: "cyan" }}>
          <Stack>
            ...
            >
              ...
              >
                Level Up : {Number(levelUpCost).toLocaleString()}
              </Typography>
              <Typography
                sx={{
                  fontFamily: "Alegreya Sans SC",
              ...
              >
                Size Up : {Number(sizeUpCost).toLocaleString()}
              </Typography>
            </Stack>
          </Stack>
        </CardContent>
