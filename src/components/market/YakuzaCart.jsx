...
const YakuzaCart = (props) => {
  ...
  return (
    <Box className="mkt-box" sx={{p:1, m:2, minHeight: 250}}>
            ...
            <ImageListItem key={fighter?.id}  >
              <CardMedia
                ...
                <Stack direction="row" sx={{justifyContent: 'space-around'}}>
                    <Typography sx={{fontFamily: 'Alegreya Sans SC', fontSize: '.7rem', color: 'aqua'}}>Rank: {fighter?.rank}</Typography>
        ...
        <Typography sx={{fontFamily: 'Alegreya Sans SC', fontSize: '1.5rem', color: 'red'}}>Yakuza Cart</Typography>
            <Button 
                variant="contained" 
                size="small" 
                onClick={props.onBuy}
