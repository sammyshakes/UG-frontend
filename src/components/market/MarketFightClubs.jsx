...
import {MarketFightClubCard } from './MarketFightClubCard';
import FightClubCart from './FightClubCart';
import CancelFighterCart from './CancelFightClubCart';
...
query GetMarket($sold: Boolean, $enabled: Boolean)  {
  listings(first: 1000, where: {enabled: $enabled, sold: $sold, tokenAddress: "0xca20c0Aa60ce8877a39AB289620435b02a5b07a6", tokenId_gt: "20000" },  orderBy: timestamp, orderDirection: desc)  {
      id
      listingId
      tokenId
      price
...
export default MarketFightClubs;
 ...
 // const [filteredFighters, setFilteredFighters] = useState([]);
  ...
  return ( 
      ...
      <Box className="mkt-box" m={1}>
        <Stack direction="row" sx={{justifyContent: 'space-between'}}>
          ...
          <FormGroup row style={{paddingLeft: 5, align: 'center', color: 'aqua'}} sx={{justifyContent: 'space-evenly'}}>
            ...
            <FormControlLabel control={<Checkbox size="small" style={{color: 'aqua'}}/>} label="9 and Up"  
              checked={checkedTier9}
              onChange={handleChange9}/>
          </FormGroup>
          </Stack>
          <Stack>
    <FormLabel style={{paddingLeft: 2, color: 'red'}} id="demo-controlled-radio-buttons-group">Size Filter:</FormLabel>
    ...
    <Stack direction="row" sx={{justifyContent: 'space-between'}}>
        ...
        <ImageList sx={{p:1,  maxHeight: '100vh'}} cols={3} rowHeight={370}  >
