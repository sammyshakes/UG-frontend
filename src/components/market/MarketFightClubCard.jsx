  ...
  return (
    <Container className="mkt-box" >             
        <Stack  align="left" spacing={1} sx={{}}>
          <Typography variant='h1'  sx={{p: 0,fontFamily: 'Alegreya Sans SC',  fontSize:'1rem', color: 'red'}}>FIGHT CLUB: {props.tokenId}</Typography>
          ...
          <Stack   >
              <Box >
                <Stack direction="row"  spacing={2}  sx={{ justifyContent: 'space-around' }} >                              
                  ...
                  <Typography variant='body2'  sx={{p: 0,fontFamily: 'Alegreya Sans SC',  fontSize:'1rem', color: 'aqua'}}>Level: {props.level}</Typography>    
                  <Typography variant='body2'  sx={{fontFamily: 'Alegreya Sans SC',  fontSize:'1rem', color: 'aqua'}}>Size: {props.size} </Typography>
