...
import {MarketRingCard } from './MarketRingCard';
import {  getUGNft2, getUGMarket, getEthers } from '../../utils.js';
import RingCart from './RingCart';
...
query GetMarket($sold: Boolean, $enabled: Boolean)  {
  listings(first: 1000, where: {enabled: $enabled, sold: $sold, tokenAddress: "0xca20c0Aa60ce8877a39AB289620435b02a5b07a6", tokenId_gt: "5000", tokenId_lt: "10000" },  orderBy: timestamp, orderDirection: desc)  {
      id
      listingId
      tokenId
      price
